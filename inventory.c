...
/*       then calls a functions to perform the requested    */
...
/*         exists, prints the name and quantity of hand;  */
...
/*         Prints and error message if the part doesn't	        */
...
/*        in which they were entered into the 		   */
/*        database.					   */
/***********************************************************/
void print (void)
{
